defmodule TodoServerWeb.TodoControllerTest do
  ...
  @create_attrs %{
    ...
    event_date: ~D[2010-04-17],
    event_status: true,
    title: "some title"
  }
  @update_attrs %{
    event_data: "some updated event_data",
    event_date: ~D[2011-05-18],
    event_status: false,
  ...
  def fixture(:todo) do
    {:ok, todo} = Store.create_todo(@create_attrs)
    todo
  end
  ...
  describe "index" do
    test "lists all todo_events", %{conn: conn} do
